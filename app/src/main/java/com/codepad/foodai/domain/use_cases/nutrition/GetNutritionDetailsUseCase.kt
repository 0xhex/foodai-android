...
class GetNutritionDetailsUseCase @Inject constructor(
    private val userRepository: UserRepository,
) {
    suspend fun getNutritionDetails(imageId: String): UseCaseResult<NutritionDetailsData> {
        return when (val result = userRepository.getNutritionDetails(imageId)) {
